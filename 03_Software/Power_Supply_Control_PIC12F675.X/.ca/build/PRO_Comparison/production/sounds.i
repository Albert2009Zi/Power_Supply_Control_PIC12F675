...
extern volatile uint8_t errorVoltage;
extern volatile uint8_t errorTemperature;
...
void playAlert() {
   ...
   switch (soundState){
     ...
     if (errorVoltage == 2) {
      ...
      if (!alarmState) soundState = 2;
     break;

     case 2:
     if (errorTemperature == 3){
       howMuchTimesPlayShort = 3;
       howMuchTimesPlayLong = 0;
       }
      if (!alarmState) soundState = 0;
     break;
